...
#-------------------------------------------------------------------------------
    ...
    #-------------------------------------------------------------------------------
        ...
        z_w = self.parent.MEASURES.getVar(14)  #grondws
        if not u_0:
            if z_w:
                z_w = float(z_w)
                u_0 = 9.81E-3 * (self.z - diepteCor - z_w)
...
class COLUMNS:
    ...
    #-------------------------------------------------------------------------------
        ...
        try:
            ...
            if self.columns.__contains__(colnr):
    ...
    #-------------------------------------------------------------------------------
        ...
        if self.__index:
            if self.__index.__contains__(id):
...
class MEASUREMENTS():
    ...
    #-------------------------------------------------------------------------------
        ...
        """
        # Created:     09/06/2015  co
        if self.measurementsText.__contains__(nr):
    ...
    #-------------------------------------------------------------------------------
        ...
        """
        # Created:     09/06/2015  co
        if self.measurementsVar.__contains__(nr):
...
class GEF:
    ...
    #-------------------------------------------------------------------------------
        ...
        """
        # Created:     09/06/2015  co
        if self.HEADER.__contains__(tag):
...
def main():
    ...
    gef.read('../data/GEF/PB_1_001_04P001442.gef',None)
    ##print gef.HEADER
##    for header in gef.HEADER:
##        print (header)

    #print (gef.MEASURES)
    print (gef.MEASURES.measurementsText[7])
    #print gef.COLUMNS
